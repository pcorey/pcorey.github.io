/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+css-extras+git+java+php+php-extras+python+scss+sql */
self =
...
(Prism.languages.javascriptDiff = {
  deleted: { pattern: /^[-<].*$/m, inside: Prism.languages.javascript },
  inserted: { pattern: /^[+>].*$/m, inside: Prism.languages.javascript },
  comment: [
    { pattern: /(^|[^\\])\/\*[\w\W]*?\*\//, lookbehind: !0 },
    { pattern: /(^|[^\\:])\/\/.*/, lookbehind: !0 },
  ],
...
Prism.languages.elixirDiff = {
  deleted: { pattern: /^[-<].*$/m, inside: Prism.languages.elixir },
  inserted: { pattern: /^[+>].*$/m, inside: Prism.languages.elixir },
  rest: Prism.languages.elixir,
};

Prism.languages.markupDiff = {
  deleted: { pattern: /^[-<].*$/m, inside: Prism.languages.markup },
  inserted: { pattern: /^[+>].*$/m, inside: Prism.languages.markup },
